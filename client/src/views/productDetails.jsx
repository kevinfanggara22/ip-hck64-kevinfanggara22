    ...
    <>
      ...
      <section className="text-gray-700 body-font overflow-hidden bg-white">
        <div className="container px-5 py-20 mx-auto">
          <div className="w-full h-full max-w max-h mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                <div className="flex">
                  ...
                  <input
                    className="border border-gray-200 rounded focus:border-sky-800"
                    type="number"
                    name="quantity"
              ...
              <form onSubmit={onSubmit}>
                <div className="flex">
                  ...
                  <ButtonMidtrans
                    grossAmount={productQuantity * productDetails?.price}
      ...
      {/* <div className="container mx-auto py-10 grid grid-cols-2 gap-12">
        <div>
          <div className="w-full max-w border border-gray-200 rounded-lg shadow">
            <img
